...
\section{Language use in online support groups} \label{sect:intro-lang-in-osg}
...
\subsection{Legitimation strategies in newcomer talk}
...
\subsection{Generic stages in Jess first post}
