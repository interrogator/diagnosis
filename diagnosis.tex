...
%It is well-established that the Internet is a popular source and vast repository of health information, the provision of which may take place via a diverse set of modes. These modes range from dedicated websites for particular health conditions or health organisations, in which healthcare professionals author content targeting healthcare consumers, to modes oriented toward intra-consumer interaction, such as social networking, web forums or wikis \cite{sillence_why_2013}. 
